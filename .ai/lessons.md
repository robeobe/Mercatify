...
This catalog indexes 1 focused lesson without loading their full text. Route the task first, then read only records whose **modules**, standalone-harness **areas**, or **topics** match the work.
...
- [Client request lists are owner-scoped on the server](lessons/client-request-owner-scope.md) — area:module-data,backend-ui; module:mercatify; topic:data-scoping,acl
