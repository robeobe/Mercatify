# mercatify — Standalone App Agent Rules
...
Enabled module facts: `api_docs`,`audit_logs`,`auth`,`configs`,`dashboards`,`directory`,`entities`,`events`,`notifications`,`query_index`,`search`.
